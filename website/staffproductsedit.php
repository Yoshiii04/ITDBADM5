...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    header("Location: staff_product_list.php?error=" . urlencode("Invalid product ID."));
    exit;
}
...
if (!$product) {
    header("Location: staff_product_list.php?error=" . urlencode("Product not found."));
    exit;
}
        ...
        <main class="main-content">
            ...
            <form class="product-form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . '?id=' . $product_id); ?>" enctype="multipart/form-data">
                ...
                <div class="btn-group">
                    ...
                    <a href="staff_product_list.php" class="btn-secondary">Cancel</a>
                </div>
            </form>
        </main>
    </div>
